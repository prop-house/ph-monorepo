...
export class ChainBase {
  ...
  public static readonly DEFAULT_EVM_RPC: Record<number, string> = {
    [ChainId.EthereumMainnet]:
      'https://mainnet.infura.io/v3/0ad93f38d5e048a19b715f15c3bbaf5e',
    [ChainId.EthereumGoerli]:
      'https://goerli.infura.io/v3/0ad93f38d5e048a19b715f15c3bbaf5e'
  };
  ...
  public static readonly EVM_TO_DEFAULT_STARKNET_RPC: Record<number, string> = {
    [ChainId.EthereumMainnet]:
      'https://starknet-mainnet.infura.io/v3/054a6e9257a94a9d91cdcbbdf3f7c1c6',
    [ChainId.EthereumGoerli]:
      'https://starknet-goerli.infura.io/v3/054a6e9257a94a9d91cdcbbdf3f7c1c6'
  };
  ...
  public get defaultProvider() {
    if (!this._defaultProvider) {
      this._defaultProvider = new JsonRpcProvider(
        ChainBase.DEFAULT_EVM_RPC[this._evmChainId]
      );
    }
