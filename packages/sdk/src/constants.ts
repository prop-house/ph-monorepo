 ...
 */
export const BALANCE_OF_SLOT_QUERY_ADDRESS =
...
const createBalanceOfSlotTracer = (assetType: AssetType) => `{
  ...
  result: function() {
    const queriedAddressIndex = this.memoryValues.findIndex(memVal => memVal === '${BigInt(
    ...
    const slotIndex = this.memoryValues[queriedAddressIndex ${
 ...
 */
export const BALANCE_OF_SLOT_TRACER = createBalanceOfSlotTracer(
  AssetType.ERC721
);
 ...
 */
export const BALANCE_OF_ERC1155_SLOT_TRACER = createBalanceOfSlotTracer(
  AssetType.ERC1155
);
...
export const PINATA_JWT =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..RHlvRAdgbG0Dlg-laK7QMR_ZHAMGCNFMM1RTlwy1RAk';
