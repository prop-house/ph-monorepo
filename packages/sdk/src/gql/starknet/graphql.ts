        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'uniqueProposers' }
                },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'OrderByProposalFields' }
          }
        },
        {
          kind: 'VariableDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'winningPosition' }
                },
...
export const ManyManyVoteVotingPowersDocument = {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'OrderByVoteFields' }
          }
        },
        {
          kind: 'VariableDefinition',
        ...
        },
        {
          ...
          type: {
            kind: 'NamedType',
            name: { kind: 'Name', value: 'Vote_filter' }
          }
        }
      ],
      selectionSet: {
  ...
  ManyManyVoteVotingPowersQuery,
  ManyManyVoteVotingPowersQueryVariables
>;
...
export const RoundProposalCountDocument = {
  ...
  RoundProposalCountQueryVariables
>;
