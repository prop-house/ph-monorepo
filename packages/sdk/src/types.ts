...
export interface PropHouseConfig<CS extends Custom | void = void>
  extends ChainConfig {
...
export interface RoundChainConfig<CS extends void | Custom = void>
  extends ChainConfig {
...
export interface GovPowerChainConfig<CS extends Custom | void>
  extends ChainConfig {
  customStrategies?: Newable<StrategyHandlerBase<GovPowerStrategyConfig<CS>>>[];
}
...
export type DefaultGovPowerConfigs =
  | BalanceOfConfig
  | BalanceOfERC20Config
  | BalanceOfERC1155Config
